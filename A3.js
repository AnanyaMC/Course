...
// JavaScript to show the disclaimer on window load
        ...
        // JavaScript function to close the disclaimer
...
function showSlides(n) {
  ...
  const dots = document.getElementsByClassName("numbertext");
...
setInterval(function () {
 ...
 const songData = [
            ...
            {name:"Bole Re Papihara", source:"Bole Re Papihara (320 kbps).mp3" ,image: "Bole Re Papihara.jpg", singer: "Vani Jairam"},
            ...
            {name:"Chelaji re",  source:"Chelaji re.mp3",image:"Chelaji re.jpg", singer: "Garba"},
            {name:"Chogada tara",  source:"Chogada tara.mp3" ,image:"Chogada tara.jpg", singer: "Garba"},
            ...
            {name:"He mune ekline", source:"He mune ekline.mp3" ,image:"He mune ekline.jpg", singer: "Garba"},
            ...
            {name:"Kevhan Tari Pahate", source:"Kevhan Tari Pahate.mp3" ,image:"Kevhan Tari Pahate.jpg", singer: "Asha Bhosle"},
            ...
            {name:"Sharad Sundar Chanderi Raati", source:"Sharad Sundar Chanderi Raati.mp3" ,image:"Sharad Sundar Chanderi Raati.jpg", singer: "Asha Bhosle"},
            {name:"Simon & Garfunkel - America", source:"Simon _ Garfunkel - America.mp3" ,image:"Simon _ Garfunkel - America.jpg", singer: "Simon & Garufunkel"},
            {name:"Simon & Garfunkel - Cecilia", source:"Simon _ Garfunkel - Cecilia.mp3" ,image:"Simon _ Garfunkel - Cecilia.jpg", singer: "Simon & Garufunkel"},
            {name:"Simon & Garfunkel - El Condor Pasa", source:"Simon _ Garfunkel - El Condor Pasa.mp3" ,image:"Simon _ Garfunkel - El Condor Pasa.jpg", singer: "Simon & Garufunkel"},
            {name:"Simon & Garfunkel - Mrs. Robinson", source:"Simon _ Garfunkel - Mrs. Robinson.mp3" ,image:"Simon _ Garfunkel - Mrs. Robinson.jpg", singer: "Simon & Garufunkel"}, 
            ...
            {name:"Supertramp - Breakfast in America", source:"Supertramp - Breakfast in America.mp3" , image: "Supertramp - Breakfast in America.jpg", singer: "Suoertramp"},
            {name:"Tara veena shyam", source:"Tara veena shyam.mp3" ,image:"Tara veena shyam.jpg", singer: "Garba"},
            ...
            {name:"Ye Re Ghana Ye Re Ghana", source:"Ye Re Ghana Ye Re Ghana.mp3"  ,image:"Ye Re Ghana Ye Re Ghana.jpg", singer: "Lata Mangeshkar & Amit Kumar"},
